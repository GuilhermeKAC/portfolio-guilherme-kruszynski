...
export const CONTACT = {
  email:    'guilherme.kac10@gmail.com',
  phone:    '+55 12 99229-5323',
  linkedin: 'https://linkedin.com/in/guilherme-kruszynski',
  github:   'https://github.com/GuilhermeKAC',
  location: 'São José dos Campos, SP',
}

export const FULL_NAME = 'Guilherme Kruszynski de Assis Cunha'
